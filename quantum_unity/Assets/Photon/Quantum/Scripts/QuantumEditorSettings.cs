...
public class QuantumEditorSettings : ScriptableObject {
  ...
  [Header("Editor Features (Experimental)")]
  [Tooltip("If enabled, AssetDB will be generated asynchronously if an asset is created/removed. This can be slower but allows for a more responsive editor. If disabled, AssetDB generation will be synchronous.")]
  public bool UseAsyncAssetDBGeneration = false;
