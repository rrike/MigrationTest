...
namespace Quantum.Editor {
  ...
  public static class MapNavMeshEditor {
    ...
    public static void UpdateDefaultMinAgentRadius() {
      var settingsValue = MapNavMesh.DefaultMinAgentRadius;
      ...
      MapNavMesh.DefaultMinAgentRadius = settingsValue;
    }
      ...
      if (MapNavMesh.NavMeshSurfaceType == null) {
        ...
        try {
          ...
          foreach (var s in surfaceObjects) {
            var assetToDelete = (UnityEngine.Object)MapNavMesh.NavMeshAssetManagerType.GetMethod("GetNavMeshAssetToDelete", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic).Invoke(instance, new object[] { s });
      ...
      public override void OnInspectorGUI() {
        ...
        using (new QuantumEditorGUI.BoxScope("Import Settings")) {
          ...
          if (data.WeldIdenticalVertices) {
            ...
            data.WeldVertexHeightEpsilon = Mathf.Max(data.WeldVertexHeightEpsilon, float.Epsilon);
          }
